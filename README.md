...
| **Lazaretto Scan** | [https://github.com/jamesdfinance-dev/lazaretto-scan-action](https://github.com/jamesdfinance-dev/lazaretto-scan-action) | GitHub Action (MIT) that scans npm packages, repos, and skills for malicious behavior via known-bad indicators plus deterministic behavioral rules; posts the verdict as a PR comment and fails the build on a malicious verdict. | ![Lazaretto](https://img.shields.io/github/stars/jamesdfinance-dev/lazaretto-scan-action?style=for-the-badge) |

...
| **Greywall** | [https://github.com/GreyhavenHQ/greywall](https://github.com/GreyhavenHQ/greywall) | Deny-by-default command sandbox for AI coding agents and CLI tools with filesystem isolation, network control, and built-in profiles for agents like Claude Code or OpenCode |![Greywall](https://img.shields.io/github/stars/GreyhavenHQ/greywall?style=for-the-badge) |

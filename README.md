...
| **Content Guard** | [https://github.com/escoffier-labs/content-guard](https://github.com/escoffier-labs/content-guard) | Policy-driven secret and PII leak scanner and publish gate for content that leaves your machine (PR bodies, docs, release notes, AI agent output). Catches hostnames, private IPs, keys, and credentials, with named policy profiles and in-place redaction. | ![Content Guard](https://img.shields.io/github/stars/escoffier-labs/content-guard?style=for-the-badge) |
